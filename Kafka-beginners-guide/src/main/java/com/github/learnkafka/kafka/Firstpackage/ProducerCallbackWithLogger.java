...
public class ProducerCallbackWithLogger {
    public static void main(String[] args) {
        System.out.println("Hello World");
        //Logger
        final Logger logger = LoggerFactory.getLogger(ProducerCallbackWithLogger.class);
        ...
        {
            ProducerRecord<String, String> producerRecord = new ProducerRecord<String, String>("new_topic", "Hello Callback" + Integer.toString(i));
